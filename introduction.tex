...
\section{What I will propose as my thesis}
To finish up completing the path of efficient indexing and use of it in the subsequent applications ..

\paragraph*{Going over the chapters}
