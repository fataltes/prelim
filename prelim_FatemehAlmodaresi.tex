...
\newcommand{\gray}{\rowcolor[gray]{0.9}}
...
\newcommand{\mems}{\texttt{MEM}s\xspace}
...
%\newcommand{\kmers}{$k$-mers\xspace}
%\newcommand{\bv}{\texttt{bv}\xspace}
%\newcommand{\ctab}{\texttt{utab}\xspace}
\newcommand{\etab}{\texttt{etab}\xspace}
%\newcommand{\cseq}{\texttt{useq}\xspace}
\newcommand{\pos}{\texttt{pos}\xspace}
\DeclareMathOperator{\hash}{h}
\newcommand*\canon[1]{\ensuremath{\hat{#1}}}
\newcommand*\rc[1]{\ensuremath{\bar{#1}}}
%\newcommand{\rank}{\texttt{rank}\xspace}
%\newcommand{\select}{\texttt{select}\xspace}
%\newcommand{\kallisto}{kallisto\xspace}
%\newcommand{\kraken}{Kraken\xspace}
\newcommand{\clark}{Clark\xspace}
%\newcommand{\bwa}{BWA\xspace}
%\newcommand{\twopaco}{TwoPaCo\xspace}
%\DeclarePairedDelimiter{\ceil}{\lceil}{\rceil}
\renewcommand{\thefootnote}{\fnsymbol{footnote}}
\newcommand{\sampvec}{\texttt{isSamp}\xspace}
\newcommand{\canonvec}{\texttt{isCanon}\xspace}
\newcommand{\extvec}{\texttt{Direction}\xspace}
\newcommand{\qextvec}{\texttt{QueryExt}\xspace}
\newcommand{\eqtab}{\texttt{eqtab}\xspace}
